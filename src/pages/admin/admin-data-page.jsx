...
function AccountDataPage() {
  ...
  const fetchSheetData = async () => {
    try {
      ...
      const response = await fetch(`https://script.google.com/macros/s/AKfycbyGf3LdYk6MPiOs_shPU9_AW7wmRjJZ4QxMk9qYqTScsDMB7IliaWRB1HueYy7w5qxqNw/exec/gviz/tq?tqx=out:json&sheet=STORE`);
